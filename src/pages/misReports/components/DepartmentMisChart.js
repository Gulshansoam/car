...
import {
  handleDownloadExcelCompanyReportDepartmentWise,
  handleDownloadExcelDepartmentWise,
} from "../downloadExcel";
import { useTheme } from "@mui/material/styles";

const DepartmentMisChart = (props) => {
  ...
  const getDepartmentData = async () => {
    setLoader(true);
    let res = await genrateMISService.departmentwiseMis(misReportForm);
    if (res.Success) {
      setValue(res.Data);
    }
  ...
  return (
    <>
      <button
        ...
        onClick={() => handleDownloadExcelDepartmentWise(misReportForm)}
        style={{
      ...
      <button
        ...
        ${loader ? "excel-disable" : "location-area-bidder-area-mis-reports "}`}
        onClick={() =>
          handleDownloadExcelCompanyReportDepartmentWise(misReportForm)
        }
        style={{
          borderColor: theme.palette.primary.darker,
          color: theme.palette.primary.darker,
...
export default DepartmentMisChart;
